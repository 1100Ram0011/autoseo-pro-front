...
import { BoldIcon, ItalicIcon, StrikeIcon, EmojiIcon, PlusIcon, InfoIcon } from './Msg91WaIcons'
import { Tooltip } from './Msg91WaBaseUI'
 ...
 */
const BodyToolbar = ({ value = '', onChange, textareaRef, showInfo }) => {
        ...
        <>
            <div style={{ display: 'flex', alignItems: 'center', gap: 0 }}>
                ...
                <button
                    type="button"
                    onClick={() => {
                        const next = getNextVariableIndex(value);
                        insert(`{{${next}}}`);
                    }}
