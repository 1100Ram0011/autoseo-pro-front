  ...
  return (
    ...
    >
        ...
        <motion.div variants={itemVariants} style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '1rem' }}>
          ...
          <div style={{ display: 'flex', gap: '1rem', alignItems: 'center', flexWrap: 'wrap' }}>
            ...
            <button 
              ...
              disabled={loading}
              style={{ padding: '0.75rem 1.25rem', background: '#FFFFFF', color: '#0F172A', border: '1px solid #E2E8F0', borderRadius: '8px', cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '8px', fontWeight: 600, transition: 'all 0.2s', whiteSpace: 'nowrap' }}
      ...
      <div style={{ display: 'flex', flexWrap: 'wrap', gap: '1.5rem', marginBottom: '2rem' }}>
        ...
        <motion.div variants={itemVariants} style={{ flex: '1 1 300px', minWidth: '280px', background: '#FFFFFF', border: '1px solid rgba(255,255,255,0.07)', borderRadius: '16px', padding: '1.5rem' }}>
      ...
      <motion.div variants={itemVariants} style={{ background: '#FFFFFF', border: '1px solid rgba(255,255,255,0.07)', borderRadius: '16px', overflowX: 'auto', overflowY: 'hidden' }}>
        <div style={{ padding: '1.25rem 1.5rem', borderBottom: '1px solid rgba(255,255,255,0.07)', background: '#FFFFFF', display: 'flex', alignItems: 'center', gap: '10px', fontSize: '1.05rem', fontWeight: 600, color: '#0F172A', minWidth: '600px' }}>
